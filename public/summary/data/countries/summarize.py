...
def level_summarization_prompt(count, lines, text):
 ...
 - Do not use any names of places or people.
   ...
   - Do not use unfamiliar word combinations. For instance, this is a bad example of a summary:
   ...
   - A better summary is like the following: "After an East India Company ship crashed in the 18th century, British traders became regular visitors". This mentions relevant entities without pinning down the geographic location.
    """
    prompt = f"""
